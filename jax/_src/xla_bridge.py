...
# TODO(yueshengys): Update the return type annotation to be `List[xla_client.MemorySpace]`, minimum xla_extension_version is 159.
def memory_spaces(
    backend: Optional[Union[str, xla_client.Client]] = None
) -> List[Any]:
  ...
  raise NotImplementedError('memory_spaces is not implemented')
